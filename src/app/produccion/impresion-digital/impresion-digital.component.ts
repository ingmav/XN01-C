...
export class ImpresionDigitalComponent implements OnInit {
  ...
  constructor(
    ...
    ngOnInit() {
      ...
      var busquedaSubject = this.terminosBusqueda
        ...
        .switchMap((term:string)  =>  { 
          ...
          this.cargando = true;
          return term  ? this.produccionService.buscar_detalle_produccion(term, this.paginaActualBusqueda, this.resultadosPorPaginaBusqueda, this.etapa_produccion) : Observable.of<any>({data:[]}) 
        }
    ...
    listar(paginate:number):void{
      ...
      this.cargando = true;
      this.produccionService.listarProduccion(paginate,this.resultadosPorPagina, this.etapa_produccion).subscribe(
        resultado => {
    ...
    listarBusquedaProduccion(term:string ,pagina:number): void {
      ...
      this.cargando = true;
      this.produccionService.buscar_detalle_produccion(term, pagina, this.resultadosPorPaginaBusqueda, this.etapa_produccion).subscribe(
          resultado => {
            this.cargando = false;
