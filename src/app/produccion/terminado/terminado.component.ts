...
export class TerminadoComponent implements OnInit {
  ...
  ngOnInit() {
    this.title.setTitle("PRODUCCIÓN TERMINADOS");
    ...
    var busquedaSubject = this.terminosBusqueda
        ...
        this.cargando = true;
	      return term  ? this.produccionService.buscar_detalle_produccion(term, this.paginaActualBusqueda, this.resultadosPorPaginaBusqueda, 4) : Observable.of<any>({data:[]}) 
	    }
  ...
  listar(paginate:number):void{
    ...
    this.cargando = true;
    this.produccionService.listarProduccion(paginate,this.resultadosPorPagina, 4).subscribe(
      resultado => {
